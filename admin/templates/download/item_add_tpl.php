...
<div class="control_frm" style="margin-top:25px;">
    <div class="bc">
        <ul id="breadcrumbs" class="breadcrumbs">
        	            <li><a href="index.php?com=download&act=man<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>"><span>File</span></a></li>
...
<form name="supplier" id="validate" class="form" action="index.php?com=download&act=save&curPage=<?=$_REQUEST['curPage']?><?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" method="post" enctype="multipart/form-data">
     ...
     <div class="widget">
       ...
       <div id="info" class="tab_content">
        ...
        <div class="formRow">
            <div class="formRight">
                ...
                <a href="index.php?com=download&act=man<?php if($_REQUEST['curPage']!='') echo'&curPage='.$_REQUEST['curPage'];?><?php if($_REQUEST['type']!='') echo'&type='.$_REQUEST['type'];?>" onClick="if(!confirm('Bạn có muốn thoát không ? ')) return false;" title="" class="button tipS" original-title="Thoát">Thoát</a>
            </div>
            <div class="clear"></div>
        </div>
       ...
       <div id="content_lang_<?=$key?>" class="tab_content">        
            ...
            <div class="formRight">
                <input type="text" name="ten<?=$key?>" title="Nhập tên file" id="ten<?=$key?>" class="tipS" value="<?=@$item['ten'.$key]?>" />
            </div>
            <div class="clear"></div>
        </div>  
...
<?php /*
	...
	{
		$sql="select * from table_download_list order by stt, id";
...
<form name="frm" method="post" action="index.php?com=download&act=save" enctype="multipart/form-data" class="nhaplieu">
	<div class="hidden"><b>Danh mục download:</b><?=get_main_list();?><br /><br /></div>
   <?php if (@$_REQUEST['act']=='edit')
	{?>
    	<b>File hiện tại:</b>
    	 <?php
			if($item['file']!=''){
		?>
			<a href="<?=_upload_product.$item['file']?>" >Download file</a><br />
		<?php
			}else{
				echo 'Chưa có file !';	
			}
    ...
    <div id="tabs_container" >
        <ul id="tabs">
            ...
            <?php /*?><li><a href="#tab3">Tiếng Trung</a></li><?php */?>
        </ul><!--tabs-->
    </div><!--tabs_container-->
    ...
    <div id="tabs_content_container">
        <div id="tab1" class="tab_content" style="display:block">
            ...
            <b>Mô tả VI</b> <textarea cols="60" rows="10" name="mota_vi" id="mota_vi"><?=$item['mota_vi']?></textarea><br/><br/>
            
           
        </div><!--tab1-->
        <div id="tab2" class="tab_content">
            <b>Tên EN</b> <input type="text" name="ten_en" value="<?=$item['ten_en']?>" class="input" /><br /><br />
           <b>Mô tả EN</b> <textarea cols="60" rows="10" name="mota_en" id="mota_en"><?=$item['mota_en']?></textarea><br/><br/>
