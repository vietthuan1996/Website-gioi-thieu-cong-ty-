...
<?php 
    if($_REQUEST['type']=='banggia' || $_REQUEST['type']=='profile'){
?>

     <div class="formRow">           
                <label>File hiện tại: </label>      
                <div class="formRight">          
                <a target="_blank" href="<?=_upload_hinhanh.$item['photo']?>"><?=$item['ten']?></a>
                <br />
                </div>
                <div class="clear"></div>
            </div>
...
?>
     <div class="formRow">
            <label>Tiêu đề: </label>
            <div class="formRight">
                <input type="text" id="price" name="ten" value="<?=@$item['ten']?>"  title="Nhập tên file" class="tipS" />
            </div>
            <div class="clear"></div>
        </div>
<?php } ?>
...
<?php 
    if($_REQUEST['type'] !='banggia' and $_REQUEST['type'] !='profile'){
?>
        <div class="formRow">
