<script language="javascript" type="text/javascript">
	...
	$("#xoahet").click(function(){
		...
		if (hoi==true) document.location = "index.php?com=module&act=delete&listid=" + listid;
	});
	});
	...
	{	
		...
		window.location ="index.php?com=module&act=man&key="+a;	
		return true;
	}	
</script>
...
<div class="control_frm" style="margin-top:25px;">
    <div class="bc">
        <ul id="breadcrumbs" class="breadcrumbs">
        	<li><a href="index.php?com=module&act=man"><span>Danh sách module</span></a></li>
        	<?php if($_GET['key']!=''){ ?>
  ...
  <table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
    <thead>
      <tr>
        ...
        <td class="sortCol"><div>Tên module<span></span></div></td>
    ...
    <tbody>
    <form name="f" id="f" method="post" action="index.php?com=module&act=savestt<?php if($_REQUEST['p']!='') echo'&p='.$_REQUEST['p'];?>">
       ...
       <td>
        ...
        <td class="title_name_data">
            <a href="index.php?com=module&act=edit&id=<?=$items[$i]['id']?><?php if($_REQUEST['p']!='') echo'&p='.$_REQUEST['p'];?>" class="tipS SC_bold">
                  <?=$items[$i]['ten']?>
            </a>
        </td>
        ...
        <td class="actBtns">
            <a href="index.php?com=module&act=edit&id=<?=$items[$i]['id']?><?php if($_REQUEST['p']!='') echo'&p='.$_REQUEST['p'];?>" title="" class="smallButton tipS" original-title="Sửa module"><img src="./images/icons/dark/pencil.png" alt=""></a>
