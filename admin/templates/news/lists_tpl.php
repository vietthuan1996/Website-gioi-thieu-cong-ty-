...
<?php	
	...
	{
		$sql="select * from table_news_item where type='".$_REQUEST['type']."' order by stt";
   ...
   <tr>
         ...
         <td align="center">
   		...
   		<td class="title_name_data">
            <a href="index.php?com=news&act=edit_list&id_item=<?=$items[$i]['id_item']?><?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>&id=<?=$items[$i]['id']?><?php if($_REQUEST['p']!='') echo'&p='.$_REQUEST['p'];?>" class="tipS SC_bold"><?=$items[$i]['ten']?></a>
        </td>
        ...
        <td class="actBtns">
            <a href="index.php?com=news&act=edit_list&id_item=<?=$items[$i]['id_item']?><?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>&id=<?=$items[$i]['id']?><?php if($_REQUEST['p']!='') echo'&p='.$_REQUEST['p'];?>" title="" class="smallButton tipS" original-title="Sửa sản phẩm"><img src="./images/icons/dark/pencil.png" alt=""></a>
