...
<div class="control_frm" style="margin-top:25px;">
    <div class="bc">
        <ul id="breadcrumbs" class="breadcrumbs">
        	            <li><a href="index.php?com=product&act=man<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>"><span>Tour</span></a></li>
...
<form name="supplier" id="validate" class="form" action="index.php?com=product&act=save&p=<?=$_REQUEST['p']?><?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" method="post" enctype="multipart/form-data">
    ...
    <?php }?>
     ...
     <div class="formRow">
            <label>Chi tiết: <img src="./images/question-button.png" alt="Chọn loại"  class="icon_que tipS" original-title="Chính sách bảo hành"> </label>
            <div class="formRight"><textarea class="ck_editor" name="chinhsach" id="chinhsach" rows="8" cols="60"><?=@$item['chinhsach']?></textarea>
</div>
            <div class="clear"></div>
        </div>
	
     <div class="formRow">
            <label>Thanh toán: <img src="./images/question-button.png" alt="Chọn loại"  class="icon_que tipS" original-title="Thanh toán"> </label>
            <div class="formRight"><textarea class="ck_editor" name="thanhtoan" id="thanhtoan" rows="8" cols="60"><?=@$item['thanhtoan']?></textarea>
</div>
            <div class="clear"></div>
        </div>
