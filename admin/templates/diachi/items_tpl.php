<script language="javascript" type="text/javascript">
	...
	$("#xoahet").click(function(){
		...
		if (hoi==true) document.location = "index.php?com=diachi&act=delete&listid=" + listid;
	});
	});
	...
	{	
		...
		window.location ="index.php?com=diachi&act=man&key="+a;	
		return true;
	}	
</script>
...
<div class="control_frm" style="margin-top:25px;">
    <div class="bc">
        <ul id="breadcrumbs" class="breadcrumbs">
        	<li><a href="index.php?com=diachi&act=man"><span>Danh sách địa chỉ</span></a></li>
        	<?php if($_GET['key']!=''){ ?>
...
<div class="control_frm" style="margin-top:0;">
    <div style="float:left;">
      <input type="button" class="blueB" value="Thêm" onclick="location.href='index.php?com=diachi&act=add'" />
...
<div class="widget">
  ...
  <table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
    ...
    <tbody>
    <form name="f" id="f" method="post" action="index.php?com=diachi&act=savestt<?php if($_REQUEST['p']!='') echo'&p='.$_REQUEST['p'];?>">
       ...
       <td>
        ...
        <td class="title_name_data">
            <a href="index.php?com=diachi&act=edit&id=<?=$items[$i]['id']?><?php if($_REQUEST['p']!='') echo'&p='.$_REQUEST['p'];?>" class="tipS SC_bold">
                  <?=$items[$i]['ten']?>
            </a>
        </td>
        ...
        <td class="actBtns">
            <a href="index.php?com=diachi&act=edit&id=<?=$items[$i]['id']?><?php if($_REQUEST['p']!='') echo'&p='.$_REQUEST['p'];?>" title="" class="smallButton tipS" original-title="Sửa địa chỉ"><img src="./images/icons/dark/pencil.png" alt=""></a>
