<?php  if(!defined('_source')) die("Error");
	...
	$page = $_GET['p'];
	$pageSize = 21;//Số item cho 1 trang
	...
	$d->reset();
	$sql = "select id,ten$lang as ten,luotxem,tenkhongdau,mota$lang as mota,noidung,photo,xuatxu,gia,giakm,thumb,thumb1,baohanh,ngaytao,photo from #_news where $where limit $bg,$pageSize";		
	$d->query($sql);
